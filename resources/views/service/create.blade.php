...
@section('page', 'Service Create Page')
...
<div style="width: 100%; display:flex;">
    @can('create models')
            <div class="search-inline">
                <a class="btn btn-primary" href="{{ route('service.create') }}" title="Add New Number"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
{!! Form::open(['route' => 'service.store', 'method' => 'post', 'class' => '']) !!}
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>{!! Form::label('code', 'Service Code') !!}</strong>
                {!! Form::text('code', null, ['placeholder'=>'Enter Service Code', 'class'=>'form-control']) !!}
            </div>
            <div class="form-group">
                <strong>{!! Form::label('name', 'Service Name') !!}</strong>
                {!! Form::text('name', null, ['placeholder'=>'Enter Service Name', 'class'=>'form-control']) !!}
            </div>
            <div class="form-group">
